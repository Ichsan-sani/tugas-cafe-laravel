...
<section id="menu" class="py-5">
    <div class="container">
        <h2 class="text-center mb-5 fade-in">Menu Inovatif Kami</h2>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card fade-in">
                    <img src="/api/placeholder/600/400" class="card-img" alt="Quantum Latte">
            ...
            <div class="col-md-4">
                <div class="card fade-in">
                    <img src="/api/placeholder/600/400" class="card-img" alt="Nebula Croissant">
                    <div class="card-img-overlay d-flex flex-column justify-content-end text-white">
            ...
            <div class="col-md-4">
                <div class="card fade-in">
                    <img src="/api/placeholder/600/400" class="card-img" alt="Levitating Salad">
                    <div class="card-img-overlay d-flex flex-column justify-content-end text-white">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 fade-in">
                <h2 class="mb-4 text-white">Tentang Cafe Moderna</h2>
                <p class="text-white">Cafe Moderna adalah titik temu antara tradisi kopi dan teknologi masa depan. Kami menghadirkan pengalaman kuliner yang tak terlupakan dengan sentuhan inovasi di setiap sajian.</p>
                <p class="text-white">Dengan barista robot kami yang presisi dan chef AI yang kreatif, kami berkomitmen untuk memberikan citarasa terdepan dalam dunia kopi dan kuliner.</p>
            </div>
        </div>
    </div>
</section>
