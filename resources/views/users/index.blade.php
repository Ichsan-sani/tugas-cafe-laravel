...
<div class="container mx-auto my-10 p-8 bg-white shadow-lg rounded-lg">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('create_user') }}" class="btn-primary text-white font-bold py-2 px-4 rounded">
            Tambah User
        </a>
    </div>
                        ...
                        <tr class="product-row border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    <a href="{{ route('edit_user', $user['id']) }}" class="btn-info text-white font-bold py-1 px-3 rounded mr-2">Edit</a>
